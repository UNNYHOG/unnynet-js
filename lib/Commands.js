...
export default class UnnyCommands {
    ...
    static jsCommands = {
        ...
        [UnnyCommands.Command.UnnyNetWasOpened]: "window.globalReactFunctions.apiUnnyNetWasOpened();",
        [UnnyCommands.Command.ReportLeaderboardScoresAsync]: "window.globalReactFunctions.apiReportLeaderboardScoresAsync(<*id*>, '{0}', {1}, '{2}');",
        [UnnyCommands.Command.ReportAchievementProgressAsync]: "window.globalReactFunctions.apiReportAchievementProgressAsync(<*id*>, {0}, {1});",
