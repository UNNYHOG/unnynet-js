...
export default class UnnyNetBase {
    ...
    constructor(config, callback) {
        ...
        UnnyNetBase.Nutaku = {
            ...
            //  */
            // authorize: function (userId, platform, oauthToken, oauthTokenSecret, autologinToken, callback) {
            //     UnnyNetBase.staticUnnyNetInstance.API.authWithNutaku(userId, platform, oauthToken, oauthTokenSecret, autologinToken, callback);
            // }
