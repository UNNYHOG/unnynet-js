...
export default class DefaultSocial {
    ...
    purchaseProduct(id, callback) {
        console.error("purchaseProduct isn't implemented for this platform");
        if (callback)
            callback(UnnynetCommand.getErrorResponse(Errors.Unknown, "purchaseProduct isn't implemented for this platform"));
    }
