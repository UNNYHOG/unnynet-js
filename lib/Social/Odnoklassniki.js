...
export default class Odnoklassniki extends DefaultSocial {
    ...
    authorize(callback) {
        this._initializeOk(() => {
            ...
            this.API.authWithOK(this.authData.auth_sig, this.authData.session_secret_key, callback);//TODO get other params
    ...
    purchaseProduct(productInfo, callback) {
        ...
        FAPI.UI.showPayment(productInfo.name, productInfo.description, productInfo.product_id, productInfo.price, null, null, "ok", "true");
    }
