...
export default class Nutaku extends DefaultSocial {
    ...
    constructor(unnyNetBase) {
        ...
        this.nutaku_platform = UnnyConstants.SubPlatform.NutakuPCBrowser;
    }
    ...
    authWithNutakuGadget(callback) {
        if (typeof gadgets !== 'undefined') {
            ...
            const url = UnnyConstants.GENERAL_CONSTANTS.API_URL + "/v1/auth/nutaku_pc?env={0}&platform={1}".format(this.config.environment, this.config.platform);
