...
export default class Nutaku extends DefaultSocial {
    ...
    constructor(unnyNetBase) {
        ...
        this.nutaku_platform = UnnyNet.NutakuPlatform.PCBrowser;
    }
    ...
    authWithNutakuGadget(callback) {
        if (typeof gadgets !== 'undefined') {
            ...
            gadgets.io.makeRequest(UnnyConstants.GENERAL_CONSTANTS.API_URL + "/v1/auth/nutaku_pc", (obj) => {
            ...
            console.warn("DEBUG AUTH with login");
            this.API.authWithLogin('test_user1', 'test_password', callback);
        }
    }
    ...
    purchaseProduct(id, callback) {//TODO get real info by id
        var itemParams1 = {};
