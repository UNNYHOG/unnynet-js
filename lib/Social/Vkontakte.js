...
export default class Vkontakte extends DefaultSocial {
    ...
    _getAdsAppId() {
        return this.allGetParams.api_id;//ads_app_id has some suffix
    }
        ...
        Utils.loadChainOfScripts([
            ...
            VK.addCallback('onOrderSuccess', (order_id) => {
                ...
                if (this.purchaseCallback)
                    this._findPendingPurchaseByField("order_id", order_id, this.purchaseCallback);
            });
    ...
    purchaseProduct(productInfo, callback) {
        ...
        const params = {
            type: 'item',
            item: productInfo.platform_product_id
        };
